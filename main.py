#  SkyNet-Userbot - telegram userbot
#  Copyright (C) 2020-present SkyNet Userbot Organization
#
...
app = Client(
    ...
    device_model=f"SkyNet-Userbot @ {gitrepo.head.commit.hexsha[:7]}",
...
async def main():
    ...
    logging.info("SkyNet-Userbot started!")
